...
# pulled from https://raw.githubusercontent.com/emltech/eml-archivematica-vagrant/master/archivematica_provisioner.sh
...
mysql-server-5.0 mysql-server/root_password password $SQL_PASSWORD
mysql-server-5.0 mysql-server/root_password_again password $SQL_PASSWORD
mysql-server-5.0 mysql-server/root_password seen true
mysql-server-5.0 mysql-server/root_password_again seen true
archivematica-mcp-server archivematica-mcp-server/password-confirm password $SQL_PASSWORD
archivematica-mcp-server archivematica-mcp-server/mysql/admin-pass password $SQL_PASSWORD
...
# use online
# sudo wget -q https://raw.githubusercontent.com/artefactual/archivematica/stable/1.4.x/localDevSetup/apache/apache.default -O /etc/apache2/sites-available/archivematica.conf
# use local
sudo cp $SHARED_DIR/config/archivematica/archivematica.conf /etc/apache2/sites-available/archivematica.conf
sudo ln -s /etc/apache2/sites-available/archivematica.conf /etc/apache2/sites-enabled/archivematica.conf
